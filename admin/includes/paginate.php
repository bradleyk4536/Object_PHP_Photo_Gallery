...
//		assign variables to object properties
		...
		public function page_total() { return ceil($this->items_total_count / $this->items_per_page); }
		public function has_previous() { return $this->previous_page() >= 1 ? true : false; }
		public function has_next() { return $this->next_page() <= $this->page_total() ? true : false; }
